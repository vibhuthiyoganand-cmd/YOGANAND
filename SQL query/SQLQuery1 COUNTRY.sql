...
select * from COUNTRY WHERE id = 103
...
SELECT * FROM Country where id = 1 or id = 99;

SELECT * FROM Country where id >= 5 and id <=10 or id >= 15 and id <=20;
...
Select * from country where name like '_%a'
...
SELECT * from students where name = 'c';

SELECT * from students where name = 'a';

SELECT * from students where name = '_a';
